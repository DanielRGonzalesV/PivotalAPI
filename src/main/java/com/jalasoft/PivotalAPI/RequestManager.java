...
public class RequestManager {
    ...
    public static Response postRequest (String endpoint, Map<String, Object> parameters) {
        ...
        return RESPONSE_SPECIFICATION.body (jsonParser.parse (parameters.toString ())).when ().post (endpoint);
    }

    public static Response deleteRequest (String endpoint) {
    return RESPONSE_SPECIFICATION.body("").when ().delete (endpoint);
    }

    public static Response putRequest(String endpoint, Map<String, Object> parameters ){
        JsonParser jsonParser = new JsonParser ();
        return RESPONSE_SPECIFICATION.body (jsonParser.parse (parameters.toString ())).when ().put(endpoint);
    }
